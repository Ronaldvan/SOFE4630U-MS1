...
#
# ❌ DISABLED:
# We are using Application Default Credentials (ADC) via `gcloud auth application-default login`
# for local development, as recommended by Google Cloud.
#
# files = glob.glob("*.json")
# os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = files[0]

# Set the project_id with your project ID
project_id = "cloudcompprojectmilestone1"   # ✅ REQUIRED

topic_name = "smartMeter";        # change it for your topic name if needed
subscription_id = "smartMeter-sub";   # change it for your subscription name if needed
...
def callback(message: pubsub_v1.subscriber.message.Message) -> None:
    ...
    print(f"Consumed record with value: {message_data}")
